    ...
    return pl.DataFrame(
        {
            ...
            "num_activations_l90d": pl.Series(activations, dtype=pl.Int32),
            "num_users": pl.Series(users, dtype=pl.Int32),
            "num_active_users_l90d": pl.Series(active_users, dtype=pl.Int32),
            "num_presentations_l90d": pl.Series(presentations, dtype=pl.Int32),
            ...
            "activation_rate_l90d": rng.beta(1, 3, n),
...
def test_real_data_smoke_end_to_end(tmp_path: Path) -> None:
    ...
    for col in ("num_activations_l90d", "num_users", "num_presentations_l90d"):
