...
doppel gen examples/customer_health.csv -n 1000 -o synth.csv --seed 1
# ok wrote 1000 rows x 15 cols -> synth.csv
# quality | marginal=0.0338 | corr=0.1062 | dcr_p5=0.0507 | text_leaks=1
# tip: column 'ultimate_domain' is 100% verbatim from source;
#      rerun with --text-policy hash to mitigate

doppel diff examples/customer_health.csv synth.csv \
